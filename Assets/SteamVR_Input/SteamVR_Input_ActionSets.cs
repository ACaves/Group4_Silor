...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_LevelThreeActions p_LevelThreeActions;
        ...
        public static SteamVR_Input_ActionSet_LevelThreeActions LevelThreeActions
        {
            get
            {
                return SteamVR_Actions.p_LevelThreeActions.GetCopy<SteamVR_Input_ActionSet_LevelThreeActions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_LevelThreeActions = ((SteamVR_Input_ActionSet_LevelThreeActions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_LevelThreeActions>("/actions/LevelThreeActions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.LevelThreeActions};
        }
    }
}
