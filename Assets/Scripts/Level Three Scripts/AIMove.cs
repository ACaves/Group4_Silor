...
public class AIMove : MonoBehaviour
{
    ...
    private AssetSpawner m_AIManager;
    ...
    void Start()
    {
        m_AIManager = transform.parent.GetComponentInParent<AssetSpawner>();
    ...
    void SetUpNPC()
    {
        ...
        else if (transform.GetComponentInChildren<Collider>()!=null && transform.GetComponent<Collider>().enabled == true)
        {
    ...
    void CollidedNPC()
    {
        ...
        int randomeNum = Random.Range(1, 100);
        if (randomeNum < 40)
            m_hasTarget = false;
    ...
    bool CanFindTarget(float start= 1f, float end = 3f)
    {
